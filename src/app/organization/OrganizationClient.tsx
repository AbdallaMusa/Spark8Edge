      ...
      >
        <motion.header variants={fadeInUp}>
          ...
          <p className="font-inter text-base md:text-lg text-[#6D8299] leading-relaxed max-w-3xl mx-auto mb-12">
            In today's fast-paced digital landscape, organizations face critical
            challenges in managing their narrative, scaling content production,
            and measuring true impact. Spark8Edge provides the tools to
...
const SERVICES = [
  ...
  },
  {
    ...
    description:
      "Scale your corporate communications with AI-powered content production systems. Our automated workflows generate high-quality video assets, infographics, and multimedia content at unprecedented speed—delivering professional-grade materials in days instead of weeks while maintaining brand consistency and reducing production costs by up to 60%.",
    keywords: [
      "Content Automation",
      ...
      >
        ...
        >
          ...
          <p className="font-inter text-base md:text-lg text-gray-300 leading-relaxed max-w-4xl mx-auto mb-8">
            Our integrated suite of{" "}
            <strong className="text-white">
              AI-powered communication tools
            </strong>{" "}
            combines <strong className="text-white">crisis management</strong>,{" "}
            <strong className="text-white">automated content production</strong>
            , and <strong className="text-white">predictive analytics</strong>{" "}
            to give enterprise organizations complete control over their
            corporate narrative.
          </p>
        </motion.header>
        ...
        <div className="relative w-full max-w-4xl mx-auto mb-12">
          <div className="absolute top-1/2 -left-4 md:-left-16 -translate-y-1/2 z-20">
            <button
              onClick={prevSlide}
              className="p-3 rounded-full bg-white/10 hover:bg-[#DFA236] text-white hover:text-[#040F2D] transition-all backdrop-blur-sm border border-white/10"
            >
              <ChevronLeft size={24} />
            </button>
          </div>
                ...
                <div className="flex flex-col md:flex-row items-start gap-4 md:gap-6">
                  ...
                  <div className="flex-1">
                    ...
                    <div
                      ...
                      role="list"
                      aria-label={`Key features of ${SERVICES[currentIndex].title}`}
                    >
...
function CaseStudiesSection() {
  const testimonials = [
    {
      quote:
        "Spark8Edge transformed our product launch. Their youth network created a buzz we simply couldn't buy with traditional ads.",
      author: "Marketing Director",
      company: "FinTech Nairobi",
    },
    {
      quote:
        "The speed of delivery is unmatched. What used to take 2 weeks now takes 2 days.",
      author: "CEO",
      ...
      >
        <motion.div variants={fadeInUp} className="text-center mb-8 md:mb-12">
          ...
          <p className="font-inter text-base md:text-lg text-[#6D8299] leading-relaxed max-w-4xl mx-auto">
            Our clients see{" "}
            <strong className="text-[#040F2D]">measurable results</strong>{" "}
            through our{" "}
            <strong className="text-[#040F2D]">data-driven PR campaigns</strong>{" "}
            and{" "}
            <strong className="text-[#040F2D]">
              AI-powered reputation management
            </strong>{" "}
            solutions. From accelerating{" "}
            <strong className="text-[#040F2D]">product launches</strong> to
            reducing{" "}
            <strong className="text-[#040F2D]">
              content production timelines
            </strong>
            , enterprise organizations trust our{" "}
            <strong className="text-[#040F2D]">
              integrated communication platform
            </strong>{" "}
            to deliver{" "}
            <strong className="text-[#040F2D]">ROI-focused outcomes</strong> at
            scale.
          </p>
        </motion.div>
...
function ConsultationFormSection() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const companyName =
        formData.get("company-name")?.toString() || "A Company";
  ...
  return (
    ...
    >
      ...
      <div className="flex-grow w-full flex flex-col">
        <div className="flex-grow w-full max-w-7xl mx-auto flex flex-col lg:grid lg:grid-cols-12 gap-12 lg:gap-20 items-center relative z-10 px-6 pt-16 lg:pt-24 pb-32">
          <div className="lg:col-span-5 text-center lg:text-left">
            <motion.div variants={fadeInUp}>
              ...
              <h2 className="font-montserrat font-black text-4xl md:text-5xl lg:text-6xl text-white uppercase leading-tight mb-6">
                Request a <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#DFA236] to-amber-500">
                  Consultation
                </span>
              </h2>
              <p className="font-inter text-lg text-gray-300 leading-relaxed max-w-md mx-auto lg:mx-0">
                Let's discuss how our AI-powered solutions can future-proof your
                brand's narrative and deliver measurable ROI.
              </p>
            </motion.div>
          </div>
              ...
              <div className="flex flex-col md:grid md:grid-cols-2 gap-6 mb-6">
                <div>
                  <label
                    ...
                    className="block font-montserrat font-bold text-xs uppercase tracking-wider text-gray-200 mb-2"
                  >
                    Company Name
                  </label>
                  <input
                    ...
                    className="w-full px-4 py-3 bg-white/5 border border-white/20 rounded-lg font-inter text-sm text-white placeholder-gray-400 focus:outline-none focus:bg-white/10 focus:border-[#DFA236] focus:ring-1 focus:ring-[#DFA236]"
                  />
                </div>
                <div>
                  <label
              ...
              <div className="mb-6">
                ...
                >
                  ...
                  <option
                    ...
                    value="AI-Driven Crisis Management"
                  >
                    AI-Driven Crisis Management
                  </option>
                  <option
                    className="text-black"
                    value="Automated Content Engines"
                  >
                    Automated Content Engines
                  </option>
                  <option className="text-black" value="Impact Analytics">
                    Impact Analytics
                  </option>
    ...
    <section className="min-h-screen md:snap-start w-full flex items-center justify-center relative overflow-hidden px-6 py-16 md:py-24">
      ...
      >
        ...
        <motion.div variants={fadeInUp} className="overflow-hidden">
          <p className="font-inter text-lg md:text-xl lg:text-2xl text-[#F4F4F9] mb-8 md:mb-12 leading-relaxed drop-shadow-[0_1px_2px_rgba(0,0,0,0.7)]">
            We combine human creativity with AI efficiency to deliver measurable
            ROI.
          </p>
          <button
            onClick={(e) => {
            ...
            className="inline-flex items-center gap-3 px-8 py-4 md:px-10 md:py-5 bg-[#DFA236] text-[#040F2D] font-montserrat font-semibold text-xs md:text-sm uppercase tracking-wider rounded hover:bg-white transition-all duration-300 active:scale-95 relative z-20"
          >
