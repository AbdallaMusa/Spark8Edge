    ...
    <section className="min-h-screen md:snap-start flex items-center justify-center relative overflow-hidden px-6 py-16 md:py-24">
      ...
      >
        ...
        <motion.button
          ...
          className="inline-flex items-center gap-3 px-10 py-5 bg-[#DFA236] text-[#040F2D] font-montserrat font-semibold text-sm uppercase tracking-wider rounded hover:bg-white transition-all duration-300 active:scale-95 relative z-20"
        >
  ...
  const features = [
    {
      ...
      description:
        "12-week intensive program combining theory with practical application in real-world scenarios.",
    },
    {
      icon: Users,
      title: "In-Person Training",
      description:
        "Physical studio environment in Westlands with collaborative workspace and peer learning.",
    },
    {
      icon: Briefcase,
      title: "Project-Based Curriculum",
      description:
        "Build a professional portfolio through structured projects and assignments.",
    },
    {
      icon: Target,
      title: "Career Development",
      description:
        "Industry-standard skills training and portfolio preparation for creative careers.",
    },
  ];
    ...
    <section className="min-h-screen md:snap-start relative bg-white overflow-hidden flex items-center justify-center px-4 py-16 md:py-24">
      ...
      >
        <motion.div variants={fadeInUp} className="text-center mb-8">
          <motion.span className="inline-block px-4 py-1 bg-[#DFA236]/10 border-2 border-[#DFA236] rounded-full text-[#DFA236] font-montserrat text-xs font-bold uppercase tracking-widest mb-3">
            Our Approach
          </motion.span>
        ...
        <div className="flex flex-col md:grid md:grid-cols-4 gap-4">
          {features.map((feature, index) => {
            ...
            return (
              ...
              >
                <motion.div className="absolute -right-8 -top-8 w-32 h-32 bg-gradient-to-br from-[#DFA236]/10 to-cyan-400/10 rounded-full blur-2xl group-hover:scale-150 transition-transform duration-700" />
  ...
  const benefits = [
    {
      ...
      description:
        "Complete 3-5 professional projects during the program. Build real work that demonstrates your capabilities to employers and clients.",
    ...
    },
    {
      ...
      description:
        "Get guidance on freelancing, job applications, and client acquisition. Learn to position yourself in the creative market.",
    ...
    },
    {
      ...
      description:
        "Master tools and workflows used by top creative professionals. Stay current with industry-standard technologies and techniques.",
                ...
                <div className="relative bg-[#0a1847] border border-white/10 rounded-2xl p-8 h-full backdrop-blur-sm">
                  <div className="flex items-start justify-between mb-6">
                    ...
                    <div className="text-right">
                      <div className="text-gray-400 font-inter text-xs uppercase tracking-wider">
                        {benefit.metric}
                      </div>
                      <div className="text-[#DFA236] font-montserrat font-bold text-sm">
                        {benefit.value}
                      </div>
                    </div>
                  </div>
...
function IntakeFormSection() {
  ...
  const [countryData, setCountryData] = useState<Record<
    string,
    { digits: number; placeholder: string; pattern: string }
  > | null>(null);
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      formData.append(
        "_subject",
        `New Youth Hub Application from ${applicantName}`,
      );
  ...
  return (
    ...
    >
      ...
      <div className="flex-grow w-full flex flex-col">
        <div className="flex-grow flex items-center justify-center px-6 pt-16 lg:pt-24 pb-32 relative z-10">
            ...
            <div className="lg:col-span-5 text-center lg:text-left space-y-8">
              <motion.div variants={fadeInUp}>
                ...
                <p className="font-inter text-lg text-gray-300 leading-relaxed max-w-md mx-auto lg:mx-0">
                  Ready to master your craft? Apply now to join our next cohort
                  of creative innovators and future leaders.
                </p>
              </motion.div>
              ...
              >
                {[
                  {
                    title: "Limited Spots",
                    desc: "Small cohorts for personalized mentorship",
                  },
                  {
                    title: "Portfolio Based",
                    desc: "Focus on practical, real-world output",
                  },
                  {
                    title: "Industry Network",
                    desc: "Direct access to hiring partners",
                  },
                ].map((item, i) => (
                  <div key={i} className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-white font-montserrat font-bold text-sm uppercase tracking-wide">
                        {item.title}
                      </h4>
              ...
              >
                ...
                <div className="flex flex-col md:grid md:grid-cols-2 gap-6 mb-6">
                  <div className="space-y-2">
                    <label
                      htmlFor="name"
                      className="block font-montserrat font-bold text-xs uppercase tracking-wider text-gray-200"
                    >
                      Full Name
                    </label>
                    <input
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-gray-400 mt-1 font-inter">
                      Enter {currentCountryData.digits} digits for{" "}
                      {selectedCountry}
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    >
                      ...
                      <option className="text-black" value="Prompt Engineering">
                        Prompt Engineering
                      </option>
                      <option className="text-black" value="Product Design">
                        Product Design
                      </option>
                    </select>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      Portfolio Link{" "}
                      <span className="text-gray-500 font-inter text-xs normal-case">
                        (Optional)
                      </span>
                    </label>
                    <input
